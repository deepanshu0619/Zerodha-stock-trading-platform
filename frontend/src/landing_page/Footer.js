    ...
    <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5 gx-5 gy-4">
          ...
          <div className="col">
            <p>Quick links</p>
            <a href="" className="text-muted text-decoration-none d-block mb-2">Upcoming IPOs</a>
            <a href="" className="text-muted text-decoration-none d-block mb-2">Brokerage charges</a>
            <a href="" className="text-muted text-decoration-none d-block mb-2">Market holidays</a>
            <a href="" className="text-muted text-decoration-none d-block mb-2">Economic calendar</a>
            <a href="" className="text-muted text-decoration-none d-block mb-2">Calculators</a>
            <a href="" className="text-muted text-decoration-none d-block mb-2">Markets</a>
            <a href="" className="text-muted text-decoration-none d-block mb-2">Sectors</a>
            <a href="" className="text-muted text-decoration-none d-block mb-2">Gift Nifty</a>
          </div>
        </div>
